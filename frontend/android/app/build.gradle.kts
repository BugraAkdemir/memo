...
// Release signing config, kept out of source control (see
// android/key.properties.example). Ported from the retired mobile client.
...
android {
    namespace = "com.memo.memo_flutter"
    ...
    defaultConfig {
        applicationId = "com.memo.memo_flutter"
