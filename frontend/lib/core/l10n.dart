...
class L10n {
  ...
  static const _tr = <String, String>{
    ...
    'tool_browser_navigate': 'Tarayıcıda Sayfa Aç',
    'tool_browser_navigate_desc': 'Memo\'nun kendi sanal alanındaki tarayıcı oturumunda bir adrese gider',
    'tool_browser_click': 'Tarayıcıda Tıkla',
    'tool_browser_click_desc': 'Tarayıcı oturumundaki bir öğeye tıklar',
    'tool_browser_type': 'Tarayıcıda Yaz',
    'tool_browser_type_desc': 'Tarayıcı oturumundaki bir alana metin yazar',
    'tool_browser_scroll': 'Tarayıcıda Kaydır',
    'tool_browser_scroll_desc': 'Tarayıcı oturumundaki sayfayı kaydırır',
    'tool_browser_screenshot': 'Tarayıcı Ekran Görüntüsü',
    'tool_browser_screenshot_desc': 'Tarayıcı oturumunun o anki görünümünü yakalar',
    'tool_browser_get_text': 'Tarayıcı Metnini Oku',
    'tool_browser_get_text_desc': 'Tarayıcı oturumundaki sayfanın görünür metnini okur',
    'tool_browser_close': 'Tarayıcı Oturumunu Kapat',
    'tool_browser_close_desc': 'Etkileşimli tarayıcı oturumunu sonlandırır',
    'browser_pane_title': 'Aracı Tarayıcısı',
    'browser_pane_empty': 'Bir adres yaz ve git — ya da aracının bir sayfa açmasını bekle.',
    'browser_pane_error': 'Ekran görüntüsü gösterilemedi',
    'browser_pane_url_hint': 'Bir adres yaz (ör. example.com)',
    'browser_pane_close': 'Tarayıcı oturumunu kapat',
    'browser_pane_open': 'Tarayıcıyı aç',
  ...
  static const _en = <String, String>{
    ...
    'tool_browser_navigate': 'Open Page in Browser',
    'tool_browser_navigate_desc': 'Navigates to a URL in Memo\'s own sandboxed browser session',
    'tool_browser_click': 'Click in Browser',
    'tool_browser_click_desc': 'Clicks an element in the browser session',
    'tool_browser_type': 'Type in Browser',
    'tool_browser_type_desc': 'Types text into a field in the browser session',
    'tool_browser_scroll': 'Scroll in Browser',
    'tool_browser_scroll_desc': 'Scrolls the page in the browser session',
    'tool_browser_screenshot': 'Browser Screenshot',
    'tool_browser_screenshot_desc': 'Captures the current view of the browser session',
    'tool_browser_get_text': 'Read Browser Text',
    'tool_browser_get_text_desc': 'Reads the visible text of the page in the browser session',
    'tool_browser_close': 'Close Browser Session',
    'tool_browser_close_desc': 'Ends the interactive browser session',
    'browser_pane_title': 'Agent Browser',
    'browser_pane_empty': 'Type an address and go — or wait for the agent to open a page.',
    'browser_pane_error': 'Could not display the screenshot',
    'browser_pane_url_hint': 'Type an address (e.g. example.com)',
    'browser_pane_close': 'Close browser session',
    'browser_pane_open': 'Open browser',
