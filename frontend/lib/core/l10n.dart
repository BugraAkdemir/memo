...
class L10n {
  ...
  static const _tr = <String, String>{
    ...
    'mascot_semantic_label': 'Memo maskotu',
    ...
    'mascot_status_done': 'Tamamlandı!',
    'mascot_status_speaking': 'Konuşuyor…',
    'mascot_skin_title': 'Maskot Karakteri',
    'mascot_skin_desc': 'Masaüstü maskotu için bir görünüm seç.',
    'mascot_skin_classic': 'Klasik',
    'mascot_skin_pixel': 'Piksel',
    'tray_open': 'Memo\'yu Aç',
    'tray_model_running': 'Yerel Model: \${name}',
    'tray_model_none': 'Yerel Model Yüklü Değil',
    'tray_mascot_show': 'Masaüstü Maskotunu Göster',
    'tray_mascot_hide': 'Masaüstü Maskotunu Kapat',
    'tray_quit': 'Çıkış',
    ...
    'memory_known_facts_hint':
        'Memo\'nun sabitlediği fact\'ler. Buradan düzenleyip silebilir, yenilerini ekleyebilirsin — modele ayrıca gönderilmez, bu zaten sohbet sırasında RAG üzerinden otomatik oluyor.',
    ...
    'memory_known_facts_add_btn': 'Yeni Ekle',
    'memory_known_facts_add_title': 'Yeni Bilgi Ekle',
    'memory_known_facts_add_hint': 'Örn: Kullanıcının köpeğinin adı Zeytin.',
    'memory_known_facts_add_success': 'Eklendi.',
    'memory_known_facts_edit_title': 'Bilgiyi Düzenle',
    'memory_known_facts_edit_tooltip': 'Düzenle',
    'memory_known_facts_edit_success': 'Güncellendi.',
    'memory_delete_tooltip': 'Sil',
    'memory_select_all_btn': 'Tümünü Seç',
    'memory_deselect_all_btn': 'Seçimi Kaldır',
    'memory_selection_count': '\${n} seçili',
    'memory_delete_selected_btn': 'Seçilenleri Sil (\${n})',
    'memory_delete_confirm_title': 'Silme Onayı',
    'memory_delete_confirm_body_many':
        '\${n} kayıt kalıcı olarak silinecek. Bu işlem geri alınamaz. Emin misin?',
    'memory_delete_confirm_body_one':
        'Bu kayıt kalıcı olarak silinecek. Bu işlem geri alınamaz. Emin misin?',
    'memory_deleted_success': '\${n} kayıt silindi.',
    'memory_conversation_title': 'Sohbet Geçmişi',
    'memory_conversation_hint':
        'Sabitlenmemiş sohbet anıların — bunları silmek sabitlenmiş fact\'lerini etkilemez, ikisini ayrı ayrı yönetebilirsin.',
    'memory_conversation_empty': 'Henüz sohbet geçmişi kaydı yok.',
    'memory_conversation_showing': '\${shown} / \${total} gösteriliyor',
    'memory_conversation_load_more': 'Daha Fazla Yükle',
    'memory_conversation_error': 'Sohbet geçmişi yüklenemedi: \${e}',
    'memory_tab_settings': 'Ayarlar',
    'memory_tab_facts': 'Bilinen Bilgiler',
    'memory_tab_history': 'Sohbet Geçmişi',
    'memory_tab_analytics': 'Analiz',
    'memory_tab_debug': 'Hata Ayıklama',
    'memory_stats_title': 'Bellek Analizi',
    'memory_stats_total': 'Toplam',
    'memory_stats_pinned': 'Sabitlenmiş',
    'memory_stats_pinned_tokens': 'Sabit Token',
    'memory_stats_this_week': 'Bu Hafta',
    'memory_stats_expiring': 'Süresi Dolacak',
    'memory_stats_most_accessed': 'En Çok Erişilen Anılar',
    ...
    'provider_free_section_title': 'Ücretsiz modeli olanlar',
    'provider_other_section_title': 'Ücretli sağlayıcılar',
    'provider_free_badge': 'Ücretsiz var',
    'pick_free_model': 'Ücretsiz model seç',
    'pick_free_model_success': '✅ Ücretsiz model seçildi: \${model}',
    'pick_free_model_none_found': 'Bu sağlayıcıda şu an ücretsiz model bulunamadı.',
    ...
    'base_url_anthropic_hint': 'Anthropic Messages API uyumlu endpoint, örn. https://host/v1 (istekler /messages\'e gider)',
    'model_label': 'Model',
    'model_step3': '3. Model',
    ...
    'stt_providers_title': 'Konuşma Tanıma Sağlayıcıları (STT)',
    'stt_providers_desc':
        'Etkin bir API sağlayıcısı varsa ses metne onunla çevrilir; yoksa yerel whisper.cpp motoruna düşülür.',
    'stt_providers_add': 'Sağlayıcı ekle',
    'stt_providers_empty':
        'Henüz sağlayıcı eklenmedi — yerel whisper.cpp kullanılıyor.',
    'stt_provider_delete': 'Sil',
    'stt_provider_delete_failed': 'Sağlayıcı silinemedi: \${err}',
    'stt_provider_save_failed': 'Sağlayıcı kaydedilemedi: \${err}',
    'tts_provider_name': 'Ad',
    'tts_provider_name_hint': 'Örn. Kişisel OpenAI',
    'tts_provider_api_key': 'API Anahtarı',
    'tts_provider_base_url': 'Temel URL',
    'tts_provider_voice': 'Ses',
    'tts_provider_voice_hint': 'Örn. alloy, echo, nova',
    'tts_provider_fetch_voices': 'Ses/model listesini getir',
    'tts_provider_pick_voice': 'Bir ses seç',
    'tts_provider_voices_failed': 'Liste alınamadı: \${err}',
    'tts_provider_voices_none': 'Bu sağlayıcı liste sunmuyor — elle gir.',
    'tts_provider_model': 'Model',
    'tts_provider_model_hint': 'Boş = sağlayıcının varsayılanı',
    'tts_provider_pick_model': 'Bir model seç',
    'tts_provider_priority': 'Öncelik',
    'tts_provider_enabled': 'Etkin',
    'tts_provider_save': 'Kaydet',
    'tts_provider_saving': 'Kaydediliyor…',
    ...
    'tool_open_app': 'Uygulama Aç',
    'tool_open_app_desc': 'Bilgisayarda bir uygulama veya tarayıcı başlatır',
  ...
  static const _en = <String, String>{
    ...
    'mascot_semantic_label': 'Memo mascot',
    ...
    'mascot_status_done': 'Completed!',
    'mascot_status_speaking': 'Speaking…',
    'mascot_skin_title': 'Mascot Character',
    'mascot_skin_desc': 'Choose a look for the desktop mascot.',
    'mascot_skin_classic': 'Classic',
    'mascot_skin_pixel': 'Pixel',
    'tray_open': 'Open Memo',
    'tray_model_running': 'Local Model: \${name}',
    'tray_model_none': 'No Local Model Loaded',
    'tray_mascot_show': 'Show Desktop Mascot',
    'tray_mascot_hide': 'Hide Desktop Mascot',
    'tray_quit': 'Quit Memo',
    'embedding_active_named': 'Embedding: \${model}',
    ...
    'memory_known_facts_hint':
        'Facts Memo has pinned. Edit or delete them here, or add new ones — none of this is sent to the model separately, that already happens automatically via RAG during chat.',
    ...
    'memory_known_facts_add_btn': 'Add New',
    'memory_known_facts_add_title': 'Add New Fact',
    'memory_known_facts_add_hint': "E.g.: User's dog is named Zeytin.",
    'memory_known_facts_add_success': 'Added.',
    'memory_known_facts_edit_title': 'Edit Fact',
    'memory_known_facts_edit_tooltip': 'Edit',
    'memory_known_facts_edit_success': 'Updated.',
    'memory_delete_tooltip': 'Delete',
    'memory_select_all_btn': 'Select All',
    'memory_deselect_all_btn': 'Deselect All',
    'memory_selection_count': '\${n} selected',
    'memory_delete_selected_btn': 'Delete Selected (\${n})',
    'memory_delete_confirm_title': 'Confirm Deletion',
    'memory_delete_confirm_body_many':
        '\${n} entries will be permanently deleted. This cannot be undone. Are you sure?',
    'memory_delete_confirm_body_one':
        'This entry will be permanently deleted. This cannot be undone. Are you sure?',
    'memory_deleted_success': '\${n} entries deleted.',
    'memory_conversation_title': 'Conversation History',
    'memory_conversation_hint':
        'Your non-pinned chat memories — deleting these does not affect your pinned facts, the two are managed separately.',
    'memory_conversation_empty': 'No conversation history yet.',
    'memory_conversation_showing': 'Showing \${shown} of \${total}',
    'memory_conversation_load_more': 'Load More',
    'memory_conversation_error': 'Could not load conversation history: \${e}',
    'memory_tab_settings': 'Settings',
    'memory_tab_facts': 'Known Facts',
    'memory_tab_history': 'Conversation History',
    'memory_tab_analytics': 'Analytics',
    'memory_tab_debug': 'Debug',
    'memory_stats_title': 'Memory Analytics',
    'memory_stats_total': 'Total',
    'memory_stats_pinned': 'Pinned',
    'memory_stats_pinned_tokens': 'Pinned Tokens',
    'memory_stats_this_week': 'This Week',
    'memory_stats_expiring': 'Expiring',
    'memory_stats_most_accessed': 'Most Accessed Memories',
    ...
    'provider_free_section_title': 'Have a free model',
    'provider_other_section_title': 'Paid providers',
    'provider_free_badge': 'Has free',
    'pick_free_model': 'Pick a free model',
    'pick_free_model_success': '✅ Picked a free model: \${model}',
    'pick_free_model_none_found': 'No free model found for this provider right now.',
    ...
    'base_url_anthropic_hint': 'Anthropic Messages API-compatible endpoint, e.g. https://host/v1 (requests go to /messages)',
    'model_label': 'Model',
    'model_step3': '3. Model',
    ...
    'stt_providers_title': 'Speech-to-Text Providers (STT)',
    'stt_providers_desc':
        'If a configured API provider is enabled, audio is transcribed with it; otherwise the local whisper.cpp engine is used.',
    'stt_providers_add': 'Add provider',
    'stt_providers_empty': 'No provider added yet — using local whisper.cpp.',
    'stt_provider_delete': 'Delete',
    'stt_provider_delete_failed': 'Could not delete provider: \${err}',
    'stt_provider_save_failed': 'Could not save provider: \${err}',
    'tts_provider_name': 'Name',
    'tts_provider_name_hint': 'e.g. My OpenAI key',
    'tts_provider_api_key': 'API Key',
    'tts_provider_base_url': 'Base URL',
    'tts_provider_voice': 'Voice',
    'tts_provider_voice_hint': 'e.g. alloy, echo, nova',
    'tts_provider_fetch_voices': 'Fetch voice / model list',
    'tts_provider_pick_voice': 'Pick a voice',
    'tts_provider_voices_failed': 'Could not fetch list: \${err}',
    'tts_provider_voices_none': 'This provider offers no list — enter it manually.',
    'tts_provider_model': 'Model',
    'tts_provider_model_hint': 'Empty = provider default',
    'tts_provider_pick_model': 'Pick a model',
    'tts_provider_priority': 'Priority',
    'tts_provider_enabled': 'Enabled',
    'tts_provider_save': 'Save',
    'tts_provider_saving': 'Saving…',
    ...
    'tool_open_app': 'Open App',
    'tool_open_app_desc': 'Launches an application or the browser on the computer',
