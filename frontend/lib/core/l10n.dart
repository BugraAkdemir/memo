...
class L10n {
  ...
  static const _tr = <String, String>{
    ...
    'tts_provider_fetch_voices': 'Sesleri getir',
    'tts_provider_pick_voice': 'Bir ses seç',
    'tts_provider_voices_failed': 'Ses listesi alınamadı: \${err}',
    'tts_provider_voices_none': 'Bu sağlayıcı ses listesi sunmuyor — elle gir.',
  ...
  static const _en = <String, String>{
    ...
    'tts_provider_fetch_voices': 'Fetch voices',
    'tts_provider_pick_voice': 'Pick a voice',
    'tts_provider_voices_failed': 'Could not fetch voices: \${err}',
    'tts_provider_voices_none': 'This provider offers no voice list — enter it manually.',
