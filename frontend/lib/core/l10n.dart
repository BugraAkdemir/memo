...
class L10n {
  ...
  static const _tr = <String, String>{
    ...
    'provider_free_section_title': 'Ücretsiz kullanılabilir',
    'provider_other_section_title': 'Diğer sağlayıcılar',
    'provider_free_badge': 'Ücretsiz',
  ...
  static const _en = <String, String>{
    ...
    'provider_free_section_title': 'Free to use',
    'provider_other_section_title': 'Other providers',
    'provider_free_badge': 'Free',
